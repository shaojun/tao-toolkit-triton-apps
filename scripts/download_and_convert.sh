...
tao-converter /tao_models/elenet_four_classes_230330_model/final_model.etlt \
              ...
              -o predictions/Softmax \
              -m 16 \
              -e /model_repository/elenet_four_classes_230330/1/model.plan
...
tao-converter /tao_models/elenet_four_classes_230331_model/final_model_elenet_4class_230331.etlt \
              -k nvidia_tlt \
              -d 3,224,224 \
              -o predictions/Softmax \
              -m 16 \
              -e /model_repository/elenet_four_classes_230331/1/model.plan
