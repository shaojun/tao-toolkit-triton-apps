...
mkdir -p ${default_model_download_path}/bicycletypenet_model
cp ${tao_triton_root}/scripts/bicycletypenet_resnet18_vehicletypenet_pruned.etlt ${default_model_download_path}/bicycletypenet_model/
