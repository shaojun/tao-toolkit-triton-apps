...
if __name__ == '__main__':
    ...
    parser.add_argument('--input-images-folder-path',
                        ...
                        default=os.path.join(
                            os.getcwd(), "/home/shao/Downloads/test_2_classes_qua_2classes_classification_mini"),
    ...
    inferencer = Inferencer(logger=logging.getLogger())
    classes = ['eb', 'non_eb']
    model_statistics = {}
    if FLAGS.enable_assess_mode:
        ...
        for single_class_folder_full_path in list(classfolders):
            ...
            for simple_file_name in sorted(os.listdir(single_class_folder_full_path)):
                ...
                with open(os.path.join(single_class_folder_full_path, simple_file_name), "rb") as image_file:
                    ...
                    try:
                        ...
                        if infered_class == 'electric_bicycle':
                            infered_class = 'ebicycle'
                        else:
                            infered_class = 'bicycle'
                        infered_server_confid = infer_server_current_ebic_confid
                    except Exception as e:
                        infered_class = 'exceptioned'
                        infered_server_confid = 0
                        print(
