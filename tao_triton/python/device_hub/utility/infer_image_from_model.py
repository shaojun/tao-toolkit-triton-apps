...
class Inferencer:
    ...
    #  def start_inference_image_from_qua_models(self, base64_image_data_text: str, callback:Callable[[tuple[Literal['bicycle', 'electric_bicycle', 'background', 'gastank', 'battery'], float]]]):
    #     # put the work into thread pool
    #     self.executor.submit(self.inference_image_from_qua_models, base64_image_data_text)
