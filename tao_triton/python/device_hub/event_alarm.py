    ...
    def processAlarms(self):
        while True:
            ...
            if not targert_alarms:
                ...
                if target_alarm.event_detector.__class__.__name__ == "ElectricBicycleEnteringEventDetector":
                ...
                elif target_alarm.event_detector.__class__.__name__ == "GasTankEnteringEventDetector":
                    post_data = {"device_id": target_alarm.event_detector.timeline.board_id, "warning_type": "0021",
                                 ...
                                 "base64string": target_alarm.imageText,
                                 "data": target_alarm.data}
                elif target_alarm.event_detector.__class__.__name__ == "BatteryEnteringEventDetector":
                    post_data = {"device_id": target_alarm.event_detector.timeline.board_id, "warning_type": "0024",
                                 ...
                                 "base64string": target_alarm.imageText,
                                 "data": target_alarm.data}
                elif target_alarm.event_detector.__class__.__name__ == "DoorOpenedForLongtimeEventDetector":
                    post_data = {"device_id": target_alarm.event_detector.timeline.board_id, "warning_type": "008",
                                 ...
                                 "base64string": target_alarm.imageText,
                                 "data": target_alarm.data}
                elif target_alarm.event_detector.__class__.__name__ == "DoorRepeatlyOpenAndCloseEventDetector":
